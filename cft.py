...
▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒""")
print(f"\033[97m╔{'═' * 71}╗")
print(f"\033[97m║\033[102m{' ' * 21}Don't attack government sites{' ' * 21}\033[0m║")
print(f"\033[97m║\033[102m{' ' * 20}Just to fight to help Palestine{' ' * 20}\033[0m║")
print(f"\033[97m║\033[102m{' ' * 25}_Use it wisely_{' ' * 25}\033[0m║")
print(f"\033[97m╚{'═' * 71}╝")
while attemps < 100:
